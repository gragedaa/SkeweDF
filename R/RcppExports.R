...
#' @export
boost_hypergeometric_2F1 <- function(a1, a2, b, theta) {
    .Call(`_SkeweDF_boost_hypergeometric_2F1`, a1, a2, b, theta)
}
...
#' @export
Kolmogorov_Waring_Moment <- function(a1, b1, theta, r) {
    .Call(`_SkeweDF_Kolmogorov_Waring_Moment`, a1, b1, theta, r)
}
